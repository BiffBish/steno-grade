import { SpectraRules } from "./rules.js";
/**
 *
 * @param {string} outline
 * @param {string} removing
 */
export function removeStartingPart(
    depth,
    outline,
    removing,
    debug = false,
 ...
 */
export function processResults(results, outline) {
 ...
 */
export function UnpackRecursively(result) {
    var finalResult = [];
...
export function Analyze(outlines, target) {
...
export function TestRuleOutline(depth, ruleOutline, outline) {
    // console.log(
...
export function FindRulesThatFitRecursively(
    memorizedData,
    depth,
    outline,
    target,
...
export function AnalyzeRecursive(outline, target) {
    var rules = SpectraRules;

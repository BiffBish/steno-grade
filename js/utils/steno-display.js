...
import { PloverPunctuation } from "../plover-translations.js";
import { Analyze } from "../spectra/spectra.js";

export default function StenoDisplay(container, translations, showEmpty) {
...
/**
 *
 * @param {object} stenoStroke
 * @param {boolean} showEmpty
 */
StenoDisplay.prototype.set = function (stenoStroke, showEmpty) {
    if (typeof stenoStroke === "string") stenoStroke = { strokes: stenoStroke };

...
import StenoDisplay from "./steno-display.js";
...
export function new_rng(seed_txt) {
    var s, i, j, tmp;
    s = new Array(256);
    for (i = 0; i < 256; ++i) {
        s[i] = i;
...
export function initializeHints(hints, floating_hints) {
...
export function setExercise(name, exercise, hints = null, options, jig) {
...
export function loadSetting(elementID, settingName) {

import { initializeHints } from "./utils/util.js";

// import spectra from "./spectra/spectra.js";
/* -----------------------------------------------------------------------
...
TypeJig.prototype.reset = function () {
    ...
    let spans = this.display.querySelectorAll("span");
    if (this.speed)
...
TypeJig.shortestTranslations = function (t) {
    ...
    let customDictionariesString = localStorage.getItem("customDictionaries");
...
TypeJig.prototype.updateWords = function (words, hardReset) {
    ...
    for (let i = 0; i < words.length; ++i) {
        ...
        if (typedWentOver) {
            ...
            typedSpan.appendChild(document.createTextNothis.inputde(word));
...
TypeJig.prototype.renderChart = function () {
    ...
    for (let i = 0; i < combinedData.length; i++) {
        ...
        let distance = combinedData[i].timeStamp - pastValue;
...
TypeJig.Timer.prototype.showTime = function () {
    ...
    this.elt.innerHTML = min + ":" + seconds;
};

...
!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        ? define(t)
        : ((e =
              "undefined" != typeof globalThis ? globalThis : e || self).less =
              t());
})(this, function () {
    "use strict";
    function e(e) {
    ...
    var i = function (t, i, n) {
        ...
        n = function (e) {
            ...
            return (
                i.currentScript ||
                (t = i.getElementsByTagName("script"))[t.length - 1]
            );
        },
        r = {
            error: function (e) {
            ...
            function e(e, t) {
                ...
                for (
                    ...
                    o
                        ...
                        : r < i.length &&
                          this.warn(
                              "missing required function in environment - " + s
                          );
                }
            }
            return (
                (e.prototype.getFileManager = function (e, t, i, n, s) {
                    ...
                    i.pluginManager &&
                        (o = []
                            .concat(o)
                            .concat(i.pluginManager.getFileManagers()));
    ...
    (c.prototype = Object.assign(new u(), {
        ...
        operate: function (e, t, i) {
            for (
                var n = new Array(3),
                    r = this.alpha * (1 - i.alpha) + i.alpha,
                    s = 0;
                s < 3;
                s++
            )
    ...
    (O.prototype.constructor = O),
        (O.prototype.toString = function (e) {
            ...
            if (e.stylize) {
                ...
                if ("function" !== s)
                    throw Error(
                        "options.stylize should be a function, got a " + s + "!"
                    );
                r = e.stylize;
            }
            if (null !== this.line) {
    ...
    F.prototype = Object.assign(new u(), {
        ...
        accept: function (e) {
            this.elements && (this.elements = e.visitArray(this.elements)),
                this.extendList &&
                    (this.extendList = e.visitArray(this.extendList)),
    ...
    var D = function (e, t, i, n, r, s, o, a) {
        (this.name = e),
            ...
            (this.inline = o || !1),
            (this.variable =
                void 0 !== a ? a : e.charAt && "@" === e.charAt(0)),
            (this.allowRoot = !0),
    ...
    T.prototype = Object.assign(new u(), {
        type: "Comment",
        genCSS: function (e, t) {
            this.debugInfo &&
                t.add(q(e, this), this.fileInfo(), this.getIndex()),
                t.add(this.value);
        },
        isSilent: function (e) {
    ...
    (z.Eval = function (e, t) {
        ...
        (z.Eval.prototype.enterCalc = function () {
            this.calcStack || (this.calcStack = []),
                this.calcStack.push(!0),
                (this.inCalc = !0);
        }),
        (z.Eval.prototype.exitCalc = function () {
            this.calcStack.pop(), this.calcStack.length || (this.inCalc = !1);
        }),
        (z.Eval.prototype.inParenthesis = function () {
            this.parensStack || (this.parensStack = []),
                this.parensStack.push(!0);
        }),
        (z.Eval.prototype.outOfParenthesis = function () {
            this.parensStack.pop();
        }),
        (z.Eval.prototype.inCalc = !1),
        (z.Eval.prototype.mathOn = !0),
        (z.Eval.prototype.isMathOn = function (e) {
            return (
                !!this.mathOn &&
                !!(
                    "/" !== e ||
        ...
        (z.Eval.prototype.pathRequiresRewrite = function (e) {
            return (this.rewriteUrls === b ? K : H)(e);
        }),
        (z.Eval.prototype.rewritePath = function (e, t) {
            var i;
            return (
                (t = t || ""),
        ...
        (z.Eval.prototype.normalizePath = function (e) {
            var t,
                i = e.split("/").reverse();
            for (e = []; 0 !== i.length; )
                switch ((t = i.pop())) {
    ...
    X.prototype = Object.assign(new u(), {
        ...
        accept: function (e) {
            this.paths
                ...
                : this.selectors &&
                  (this.selectors = e.visitArray(this.selectors)),
                this.rules &&
                    this.rules.length &&
        ...
        eval: function (e) {
            ...
            d || (e.selectors = d = []),
                ...
                (p.root || p.allowImports || !p.strictImports) &&
                    p.evalImports(e);
            var m = p.rules;
        ...
        matchCondition: function (e, t) {
            ...
            return (
                !!i.evaldCondition &&
                !(i.condition && !i.condition.eval(new z.Eval(t, t.frames)))
            );
        },
        resetCache: function () {
            (this._rulesets = null),
        ...
        genCSS: function (e, t) {
            ...
            for (i = 0; (s = a[i]); i++) {
                ...
                s.isRulesetLike(s) && (e.lastRule = !1),
                    s.genCSS
                        ? s.genCSS(e, t)
                        : s.value && t.add(s.value.toString()),
                    (e.lastRule = m),
        ...
        joinSelector: function (e, t, i) {
            ...
            function r(e, t) {
                var i;
                return (
                    (i = new m(null, e, t.isVariable, t._index, t._fileInfo)),
                    new F([i])
                );
            }
            function s(e, t, i, n) {
                ...
                if (
                    ...
                    e.length > 0
                        ? ((s = (r = k(e)).pop()),
                          (o = n.createDerived(k(s.elements))))
                        : (o = n.createDerived([])),
                    t.length > 0)
                ) {
                    var a = i.combinator,
    ...
    var Y = function (e, t, i, n, r, s, o, a) {
        ...
        if (
            ((this.name = e),
            (this.value = t instanceof u ? t : t ? new j(t) : t),
            i)
        ) {
            for (
                Array.isArray(i)
    ...
    Y.prototype = Object.assign(new u(), {
        ...
        find: function () {
            if (this.rules)
                return X.prototype.find.apply(this.rules[0], arguments);
        },
        rulesets: function () {
    ...
    ee.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            return new ee(this.ruleset, t);
        },
        callEval: function (e) {
            return this.ruleset.eval(
                this.frames ? new z.Eval(e, this.frames.concat(e.frames)) : e
            );
        },
    });
    var te = function (e, t, i) {
        (this.numerator = e ? k(e).sort() : []),
            ...
            i
                ? (this.backupUnit = i)
                : e && e.length && (this.backupUnit = e[0]);
    };
    ...
    var ie = function (e, t) {
        ...
        (this.unit = t && t instanceof te ? t : new te(t ? [t] : void 0)),
    ...
    ie.prototype = Object.assign(new u(), {
            ...
            if ("+" === t || "-" === t)
                if (0 === r.numerator.length && 0 === r.denominator.length)
                    (r = i.unit.clone()),
                        this.unit.backupUnit &&
                            (r.backupUnit = this.unit.backupUnit);
                else if (
                    0 === i.unit.numerator.length &&
                    0 === r.denominator.length
                );
                else {
                    if (
                ...
                "*" === t
                    ? ((r.numerator = r.numerator
                          .concat(i.unit.numerator)
                          .sort()),
                      (r.denominator = r.denominator
                          .concat(i.unit.denominator)
                          .sort()),
                      r.cancel())
                    : "/" === t &&
                      ((r.numerator = r.numerator
        ...
        compare: function (e) {
            var t, i;
            if (e instanceof ie) {
                if (this.unit.isEmpty() || e.unit.isEmpty())
                    (t = this), (i = e);
                else if (
                    ((t = this.unify()),
                    (i = e.unify()),
                    0 !== t.unit.compare(i.unit))
                )
                    return;
    ...
    re.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            if (e.isMathOn(this.op)) {
                if (
                    ((t = "./" === this.op ? "/" : this.op),
                    i instanceof ie && n instanceof c && (i = i.toColor()),
                    n instanceof ie && i instanceof c && (n = n.toColor()),
                    !i.operate || !n.operate)
                ) {
                    if (
                        (i instanceof re || n instanceof re) &&
                        "/" === i.op &&
                        e.math === ne.PARENS_DIVISION
                    )
                        return new re(this.op, [i, n], this.isSpaced);
                    throw {
                        type: "Operation",
    ...
    ae.prototype = Object.assign(new u(), {
        ...
        genCSS: function (e, t) {
            ...
            for (var i = 0; i < this.args.length; i++)
                this.args[i].genCSS(e, t),
                    i + 1 < this.args.length && t.add(", ");
            t.add(")");
        },
    });
    ...
    ue.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            var t,
                i = this.name,
                n =
                    e.pluginManager.less.visitors.ToCSSVisitor.prototype
                        ._mergeRules;
            if (this.evaluating)
                throw {
                    type: "Name",
    ...
    he.prototype = Object.assign(new u(), {
        type: "Quoted",
        genCSS: function (e, t) {
        ...
        eval: function (e) {
            ...
            return (
                (i = n(i, this.variableRegex, function (i, n) {
                    var r = new le("@" + n, t.getIndex(), t.fileInfo()).eval(
                        e,
                        !0
                    );
                    return r instanceof he ? r.value : r.toCSS();
                })),
                (i = n(i, this.propRegex, function (i, n) {
                    var r = new ue("$" + n, t.getIndex(), t.fileInfo()).eval(
                        e,
                        !0
                    );
                    return r instanceof he ? r.value : r.toCSS();
    ...
    fe.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            if (
                !this.isEvald &&
                ("string" ==
                    typeof (t = this.fileInfo() && this.fileInfo().rootpath) &&
    ...
    pe.prototype = Object.assign(new Y(), {
        type: "Media",
        isRulesetLike: function () {
            return !0;
        },
        ...
        evalTop: function (e) {
            ...
            if (e.mediaBlocks.length > 1) {
                ...
                ((t = new X(i, e.mediaBlocks)).multiMedia = !0),
        ...
        permute: function (e) {
            ...
            for (
                var t = [], i = this.permute(e.slice(1)), n = 0;
                n < i.length;
                n++
            )
        ...
        bubbleSelectors: function (e) {
            e &&
                ((this.rules = [new X(k(e), [this.rules[0]])]),
                this.setParent(this.rules, this));
        },
    });
    var ve = function (e, t, i, n, r, s) {
        if (
            ((this.options = i),
            (this._index = n),
            (this._fileInfo = r),
    ...
    ve.prototype = Object.assign(new u(), {
        ...
        getPath: function () {
            return this.path instanceof fe
        ...
        isVariableImport: function () {
            ...
            return (
                ...
                !(e instanceof he) || e.containsVariables()
            );
        },
        ...
        doEval: function (e) {
            ...
            if (this.css) {
                var s = new ve(this.evalPath(e), n, this.options, this._index);
                if (!s.css && this.error) throw this.error;
                return s;
            }
            return this.root
                ? ((t = new X(null, k(this.root.rules))).evalImports(e),
                  this.features
                      ? new pe(t.rules, this.features.value)
                      : t.rules)
                : [];
        },
    });
    ...
    de.prototype = Object.assign(new u(), {
        evaluateJavaScript: function (e, t) {
            ...
            e = e.replace(/@\{([\w-]+)\}/g, function (e, i) {
                return n.jsify(
                    new le("@" + i, n.getIndex(), n.fileInfo()).eval(t)
                );
            });
            try {
    ...
    me.prototype = Object.assign(new de(), {
        type: "JavaScript",
        eval: function (e) {
            ...
            return "number" !== i || isNaN(t)
                ? "string" === i
                    ? new he('"' + t + '"', t, this.escaped, this._index)
                    : Array.isArray(t)
                    ? new j(t.join(", "))
                    : new j(t)
                : new ie(t);
    ...
    ge.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            return this.value.eval
                ? new ge(this.key, this.value.eval(e))
                : this;
        },
        genCSS: function (e, t) {
            t.add(this.key + "="),
    ...
    be.prototype = Object.assign(new u(), { type: "UnicodeDescriptor" });
    var we = function (e) {
        this.value = e;
    };
    we.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            return e.isMathOn()
                ? new re("*", [new ie(-1), this.value]).eval(e)
    ...
    Ie.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            for (t = 0; t < this.lookups.length; t++) {
                if (
                    ((i = this.lookups[t]),
                    Array.isArray(n) && (n = new X([new F()], n)),
                    "" === i)
                )
                    n = n.lastDeclaration();
                else if ("@" === i.charAt(0)) {
                    if (
                        ("@" === i.charAt(1) &&
                            (i = "@" + new le(i.substr(1)).eval(e).value),
                ...
                n.value && (n = n.eval(e).value),
                    n.ruleset && (n = n.ruleset.eval(e));
            }
            return n;
        },
    });
    ...
    Ce.prototype = Object.assign(new X(), {
        ...
        evalParams: function (e, t, i, n) {
            ...
            if (
                (t.frames &&
                    ...
                    (f.functionRegistry =
                        t.frames[0].functionRegistry.inherit()),
                (t = new z.Eval(t, [f].concat(t.frames))),
                i)
            )
                ...
                if (!n[o]) {
                    if (((s = i && i[h]), (u = p[o].name)))
                        if (p[o].variadic) {
                            ...
                            f.prependRule(new D(u, new se(r).eval(e)));
                        } else {
                            if ((l = s && s.value))
                                l = Array.isArray(l)
                                    ? new ee(new X("", l))
        ...
        evalCall: function (e, t, i) {
            var n,
                ...
                a = this.evalParams(e, new z.Eval(e, o), t, s);
            return (
                a.prependRule(new D("@arguments", new se(s).eval(e))),
                (n = k(this.rules)),
                ((r = new X(null, n)).originalRuleset = this),
                (r = r.eval(new z.Eval(e, [this, a].concat(o)))),
                i && (r = r.makeImportant()),
                r
            );
        },
        ...
        matchArgs: function (e, t) {
            ...
            for (var o = 0; o < i; o++)
                if (
                    ...
                    e[o].value.eval(t).toCSS() !=
                        this.params[o].value.eval(t).toCSS()
                )
                    return !1;
            return !0;
        },
    ...
    ke.prototype = Object.assign(new u(), {
        type: "MixinCall",
        accept: function (e) {
        ...
        eval: function (e) {
            ...
            for (
                ...
                if (
                    ...
                    for (s = s.value, a = 0; a < s.length; a++)
                        m.push({ value: s[a] });
                    ...
                    for (c = !0, a = 0; a < t.length; a++) {
                        for (
                            ...
                            if (
                                !(i instanceof Ce) &&
                                i ===
                                    (e.frames[l].originalRuleset || e.frames[l])
                            ) {
                                u = !0;
                                break;
                            }
        ...
        Ae = (function () {
            ...
            return (
                ...
                (e.prototype.pathDiff = function (e, t) {
                    ...
                    for (
                        n = Math.max(
                            a.directories.length,
                            o.directories.length
                        ),
                            i = 0;
                    ...
                    for (
                        s = a.directories.slice(i),
                            r = o.directories.slice(i),
                            i = 0;
                        i < s.length - 1;
                        i++
                    )
                ...
                (e.prototype.extractUrlParts = function (e, t) {
                    ...
                    if (!s)
                        throw new Error(
                            "Could not parse sheet href - '" + e + "'"
                        );
                    if (t && (!s[1] || s[2])) {
                        if (!(n = t.match(r)))
                            throw new Error(
                                "Could not parse page url - '" + t + "'"
                            );
                        (s[1] = s[1] || n[1] || ""),
                            s[2] || (s[3] = n[3] + s[3]);
                    }
        ...
        Me = (function () {
            ...
            return (
                (e.prototype.evalPlugin = function (e, t, i, n, r) {
                    ...
                    var h = new this.less.FileManager().extractUrlParts(
                        u
                    ).filename;
                    if (u && (o = l.get(u))) {
                    ...
                    if (
                        ...
                        return o;
                    if (!o)
                        return new O({ message: "Not a valid plugin" }, i, u);
                    if (
                        ((o.imports = i),
                        (o.filename = u),
                        (!o.minVersion ||
                            this.compareVersion("3.0.0", o.minVersion) < 0) &&
                ...
                (e.prototype.validatePlugin = function (e, t, i) {
                    return e
                        ? ("function" == typeof e && (e = new e()),
                          e.minVersion &&
                          this.compareVersion(e.minVersion, this.less.version) <
                              0
                              ? new O({
                                    message:
                                        "Plugin " +
    ...
    var Oe = (function () {
            ...
            return (
                (e.prototype.visit = function (e) {
                    ...
                    if (!t)
                        return (
                            e.value && e.value.typeIndex && this.visit(e.value),
                            e
                        );
                    var i,
    ...
    Fe.prototype = {
        ...
        visitImport: function (e, t) {
            ...
            if (!e.css || i) {
                var n = new z.Eval(this.context, k(this.context.frames)),
                    r = n.frames[0];
                this.importCount++,
                    e.isVariableImport()
        ...
        processImportNode: function (e, t, i) {
            ...
            try {
                ...
                t.filename ||
                    ((t.index = e.getIndex()),
                    (t.filename = e.fileInfo().filename)),
                    (e.css = !0),
                    (e.error = t);
            }
            if (!n || (n.css && !r))
        ...
        onImported: function (e, t, i, n, r, s) {
            i &&
                (i.filename ||
                    ((i.index = e.getIndex()),
                    (i.filename = e.fileInfo().filename)),
                (this.error = i));
            var o = this,
                a = e.options.inline,
    ...
    var $e = (function () {
        ...
        Le = (function () {
            ...
            return (
                (e.prototype.run = function (e) {
                    return (
                        ((e = this._visitor.visit(e)).allExtends =
                        ...
                        for (i = 0; i < u.length; i++) {
                            ...
                            for (
                                ...
                                (this.foundExtends = !0),
                                    ...
                                    (r.ruleset = e),
                                    0 === n &&
                                        (r.firstExtendOnThisSelectorPath = !0),
                                    this.allExtendsStack[
                ...
                (e.prototype.visitMedia = function (e, t) {
                    (e.allExtends = []),
                        this.allExtendsStack.push(e.allExtends);
                }),
        ...
        je = (function () {
            ...
            return (
                (e.prototype.run = function (e) {
                    var t = new Le();
                    if (((this.extendIndices = {}), t.run(e), !t.foundExtends))
                        return e;
                        ...
                        for (n = t[i], r = 0; r < n.elements.length; r++)
                            for (
                                ...
                                (l = c[a]),
                                    ...
                                    (l.matched > 0 &&
                                        u[l.matched].combinator.value !== o)
                                        ? (l = null)
                                        : l.matched++,
                                    l &&
                ...
                (e.prototype.isElementValuesEqual = function (e, t) {
                    ...
                    if (
                        ((e = e.value), (t = t.value), e instanceof _e.Selector)
                    ) {
                        if (
                ...
                (e.prototype.extendSelector = function (e, t, i, n) {
                    ...
                    for (r = 0; r < e.length; r++)
                        (s = t[(a = e[r]).pathIndex]),
                            ...
                            a.pathIndex > u &&
                                c > 0 &&
                                ((h[h.length - 1].elements = h[
                                    h.length - 1
                                ].elements.concat(t[u].elements.slice(c))),
                                (c = 0),
                                u++),
                            (l = s.elements
                                .slice(c, a.index)
                            ...
                            (u = a.endPathIndex),
                            (c = a.endPathElementIndex) >=
                                t[u].elements.length && ((c = 0), u++);
                    return (
                        u < t.length &&
                            c > 0 &&
                            ((h[h.length - 1].elements = h[
                            ...
                            u++),
                        (h = (h = h.concat(t.slice(u, t.length))).map(function (
                            e
                        ) {
        ...
        Ne = (function () {
            function e() {
                (this.contexts = [[]]), (this._visitor = new Oe(this));
            }
            return (
                (e.prototype.run = function (e) {
            ...
            return (
                ...
                (e.prototype.resolveVisibility = function (e, t) {
                    if (!e.blocksVisibility()) {
                        if (
                            this.isEmpty(e) &&
                            !this.containsSilentNonBlockedChild(t)
                        )
                            return;
                        return e;
                    }
                    ...
                    if ((this.keepOnlyVisibleChilds(i), !this.isEmpty(i)))
                        return (
                            e.ensureVisibility(), e.removeVisibilityBlock(), e
                        );
                }),
                (e.prototype.isVisibleRuleset = function (e) {
                    return (
                        !!e.firstRoot ||
                        (!this.isEmpty(e) &&
                            !(!e.root && !this.hasVisibleSelector(e)))
                    );
                }),
                e
            );
    ...
    Be.prototype = {
        ...
        visitRuleset: function (e, t) {
            ...
            return (
                e.rules &&
                    (this._mergeRules(e.rules),
                    this._removeDuplicateRules(e.rules)),
            ...
            return {
                ...
                parse: function (a, l, u) {
                    ...
                    (h || (u && u.banner)) &&
                        ...
                        ((p = i.contentsIgnoredChars)[n.filename] =
                            p[n.filename] || 0),
                        ...
                        (a =
                            ...
                            f),
                        (i.contents[n.filename] = a);
                    try {
                        s.start(a, t.chunkInput, function (e, t) {
                            throw new O(
                                {
                                    index: t,
                                    type: "Parse",
                            ...
                            (c = new _e.Ruleset(null, this.parsers.primary())),
                            (_e.Node.prototype.rootNode = c),
                            (c.root = !0),
                            (c.firstRoot = !0),
                            (c.functionRegistry = Z.inherit());
                    } catch (e) {
                        return l(new O(e, i, n.filename));
                    }
                    var y = s.end();
                    if (!y.isFinished) {
                    ...
                    var w = function (e) {
                        return (e = v || e || i.error)
                            ? (e instanceof O || (e = new O(e, i, n.filename)),
                              l(e))
                            : l(null, c);
                    };
                    if (!1 === t.processImports) return w();
                    new Ue.ImportVisitor(i, w).run(c);
                },
                parsers: (r = {
                    primary: function () {
                    ...
                    entities: {
                        ...
                        keyword: function () {
                            ...
                            if (e)
                                return (
                                    _e.Color.fromKeyword(e) || new _e.Keyword(e)
                                );
                        },
                        call: function () {
                            var e,
                        ...
                        assignment: function () {
                            ...
                            if ((s.save(), (e = s.$re(/^\w+(?=\s?=)/i))))
                                if (s.$char("=")) {
                                    if ((t = r.entity()))
                                        return (
                                            s.forget(), new _e.Assignment(e, t)
                                        );
                                    s.restore();
                                } else s.restore();
                            else s.restore();
                        ...
                        color: function () {
                            ...
                            if (
                                ...
                                return (
                                    s.forget(), new _e.Color(e[1], void 0, e[0])
                                );
                            s.restore();
                        },
                    ...
                    mixin: {
                        ...
                        args: function (e) {
                            ...
                            for (s.save(); ; ) {
                                if (e)
                                    u = r.detachedRuleset() || r.expression();
                                else {
                                    if (
                                ...
                                if (
                                    (e
                                        ...
                                        : (g = u),
                                    g &&
                                        (g instanceof _e.Variable ||
                                            g instanceof _e.Property))
                                )
                                    if (s.$char(":")) {
                                        if (
                                            (p.length > 0 &&
                    ...
                    selector: function (e) {
                        ...
                        if (t) return new _e.Selector(t, u, h, f, n);
                        u &&
                            o(
                    ...
                    declaration: function () {
                        ...
                        if ("." !== u && "#" !== u && "&" !== u && ":" !== u)
                            if (
                                (s.save(),
                                (e = this.variable() || this.ruleProperty()))
                            ) {
                                if (
                                    ((a = "string" == typeof e) &&
                                ...
                                if (t && (this.end() || i))
                                    return (
                                        s.forget(),
                                        new _e.Declaration(e, t, r, o, l, n)
                                    );
                                s.restore();
                            } else s.restore();
                    },
                    ...
                    permissiveValue: function (e) {
                        ...
                        if (!h()) {
                            ...
                            if ((s.save(), (a = s.$parseUntil(l)))) {
                                ...
                                return s.forget(), new _e.Expression(c, !0);
                            }
                            s.restore();
                        }
                    },
                    ...
                    mediaFeature: function () {
                        ...
                        if ((s.forget(), r.length > 0))
                            return new _e.Expression(r);
                    },
                        ...
                        if (s.$re(/^@plugin\s+/)) {
                            if (
                                ...
                                return (
                                    s.$char(";") ||
                                        ((s.i = r),
                                        o("missing semi-colon on @plugin")),
                    ...
                    sub: function () {
                        ...
                        if ((s.save(), s.$char("(")))
                            return (e = this.addition()) && s.$char(")")
                                ? (s.forget(),
                                  ((t = new _e.Expression([e])).parens = !0),
                                  t)
                    ...
                    conditionAnd: function (e) {
                        ...
                        if (
                            (t =
                                (r =
                                    o.negatedCondition(e) ||
                                    o.parenthesisCondition(e)) || e
                                    ? r
                                    : o.atomicCondition(e))
                        ) {
                            if ((i = s.$str("and"))) {
                    ...
                    operand: function () {
                        ...
                        return (
                            e &&
                                ((i.parensInOp = !0), (i = new _e.Negative(i))),
                            i
                        );
                    },
                    expression: function () {
                        ...
                        do {
                            (e = this.comment())
                                ...
                                : ((e =
                                      this.addition() ||
                                      this.entity()) instanceof _e.Comment &&
                                      (e = null),
                                  e &&
                                      (i.push(e),
                                      s.peek(/^\/[\/*]/) ||
                                          ((t = s.$char("/")) &&
                                              i.push(new _e.Anonymous(t, n)))));
                        } while (e);
                    ...
                    ruleProperty: function () {
                        ...
                        if (o)
                            return (i = [new _e.Keyword(o[1])]), s.forget(), i;
                        function a(e) {
                            var t = s.i,
                                n = s.$re(e);
    ...
    var Ye = (We = {
        rgb: function (e, t, i) {
            ...
            if (e instanceof se) {
                var r = e.value;
                if (((e = r[0]), (t = r[1]), (i = r[2]) instanceof re)) {
                    var s = i;
                    (i = s.operands[0]), (n = s.operands[1]);
                }
            }
            var o = We.rgba(e, t, i, n);
        ...
        hue: function (e) {
            return new ie(Ze(e).h);
        },
        saturation: function (e) {
            return new ie(100 * Ze(e).s, "%");
        },
        lightness: function (e) {
            return new ie(100 * Ze(e).l, "%");
        },
        hsvhue: function (e) {
            return new ie(Qe(e).h);
        },
        hsvsaturation: function (e) {
            return new ie(100 * Qe(e).s, "%");
        },
        hsvvalue: function (e) {
            return new ie(100 * Qe(e).v, "%");
        },
        red: function (e) {
        ...
        fade: function (e, t) {
            var i = Ze(e);
            return (i.a = t.value / 100), (i.a = He(i.a)), Ke(e, i);
        },
        spin: function (e, t) {
            var i = Ze(e),
                n = (i.h + t.value) % 360;
        ...
        greyscale: function (e) {
            return We.desaturate(e, new ie(100));
        },
        contrast: function (e, t, i, n) {
            if (!e.rgb) return null;
            if (
                (void 0 === i && (i = We.rgba(255, 255, 255, 1)),
                void 0 === t && (t = We.rgba(0, 0, 0, 1)),
                t.luma() > i.luma())
            ) {
                var r = i;
                (i = t), (t = r);
        ...
        tint: function (e, t) {
            return We.mix(We.rgb(255, 255, 255), e, t);
        },
        shade: function (e, t) {
            return We.mix(We.rgb(0, 0, 0), e, t);
        },
    });
    function et(e, t, i) {
        var n,
    ...
    var tt = {
        ...
        overlay: function (e, t) {
            return (e *= 2) <= 1 ? tt.multiply(e, t) : tt.screen(e - 1, t);
        },
        softlight: function (e, t) {
            ...
            return (
                t > 0.5 &&
                    ((n = 1),
                    (i =
                        e > 0.25 ? Math.sqrt(e) : ((16 * e - 12) * e + 4) * e)),
                e - (1 - 2 * t) * n * (i - e)
            );
        },
        hardlight: function (e, t) {
            return tt.overlay(t, e);
        },
    ...
    for (var it in tt)
        tt.hasOwnProperty(it) && (et[it] = et.bind(null, tt[it]));
    var nt = function (e) {
        ...
        rt = {
            ...
            extract: function (e, t) {
                return (t = t.value - 1), nt(e)[t];
            },
            length: function (e) {
                return new ie(nt(e).length);
            },
            range: function (e, t, i) {
                var n,
                    ...
                    o = [];
                t
                    ? ((r = t), (n = e.value), i && (s = i.value))
                    : ((n = 1), (r = e));
                for (var a = n; a <= r.value; a += s) o.push(new ie(a, r.unit));
                return new se(o);
            },
            each: function (e, t) {
                var i,
    ...
    for (var at in ot)
        ot.hasOwnProperty(at) && (ot[at] = st.bind(null, Math[at], ot[at]));
    ot.round = function (e, t) {
    ...
    var lt = function (e, t) {
                                ...
                                (a =
                                    "" ===
                                        (s =
                                            "" === r.unit.toString() &&
                                            void 0 !== u
                                                ? new ie(r.value, u).unify()
                                                : r.unify()).unit.toString() &&
                                    void 0 !== l
                                        ? l
                                        : s.unit.toString()) &&
                                void 0 === l) ||
        ...
        ut = {
            ...
            pow: function (e, t) {
                ...
                else if (!(e instanceof ie && t instanceof ie))
                    throw {
                        type: "Argument",
        ...
        ct = {
            e: function (e) {
                return new he('"', e instanceof me ? e.evaluated : e.value, !0);
            },
            escape: function (e) {
                return new j(
                    encodeURI(e.value)
        ...
        ft = function (e, t) {
            ...
            if (
                "string" !=
                typeof (t = "string" == typeof t.value ? t.value : t)
            )
                throw {
                    type: "Argument",
                    message:
            ...
            return e instanceof ie && e.unit.is(t) ? L.True : L.False;
        },
        pt = {
        ...
        vt = function (e) {
            var t = { functionRegistry: Z, functionCaller: oe };
            return (
                Z.addMultiple(Je),
                Z.add("default", Q.eval.bind(Q)),
                Z.addMultiple(Ye),
                Z.addMultiple(et),
                Z.addMultiple(
                    (function (e) {
                        var t = function (e, t) {
                            return new fe(t, e.index, e.currentFileInfo).eval(
                                e.context
                            );
                        };
                        return {
            ...
            ((n = Object.keys(n).map(function (e) {
                ...
                return (
                    t instanceof _e.Value ||
                        (t instanceof _e.Expression ||
                            (t = new _e.Expression([t])),
                        (t = new _e.Value([t]))),
            ...
            return (function () {
                ...
                return (
                    (t.prototype.toCSS = function (t) {
                        ...
                        if (t.pluginManager)
                            for (
                                var l = t.pluginManager.getPostProcessors(),
                                    u = 0;
                                u < l.length;
                                u++
                            )
                        ...
                        for (var c in (t.sourceMap &&
                            (s.map = n.getExternalSourceMap()),
                        (s.imports = []),
                        this.imports.files))
                    ...
                    return (
                        (i.prototype.toCSS = function (t, i, n) {
                            var r = new e({
                                    ...
                                    outputFilename:
                                        this.options.sourceMapOutputFilename,
                                    sourceMapBasepath:
                            ...
                            return (
                                ...
                                void 0 !== this.options.sourceMapBasepath &&
                                    ...
                                    (this.sourceMapURL = r.removeBasepath(
                                        this.sourceMapURL
                                    )),
                        ...
                        function t(t) {
                            (this._css = []),
                                ...
                                (this._contentsIgnoredCharsMap =
                                    t.contentsIgnoredCharsMap),
                                t.sourceMapFilename &&
                                    (this._sourceMapFilename =
                                        t.sourceMapFilename.replace(
                                            /\\/g,
                                            "/"
                                        )),
                                ...
                                t.sourceMapBasepath &&
                                    (this._sourceMapBasepath =
                                        t.sourceMapBasepath.replace(
                                            /\\/g,
                                            "/"
                                        )),
                                t.sourceMapRootpath
                                    ? ((this._sourceMapRootpath =
                                          t.sourceMapRootpath.replace(
                                              /\\/g,
                                              "/"
                                          )),
                                      "/" !==
        ...
        var u,
            ...
            h = (function (e, t, i) {
                var n = function (e, t, r) {
                    ...
                    var o,
                        a = void 0,
                        l = new yt(this, !t.reUsePluginManager);
                    if (
                        ((t.pluginManager = l),
                        (o = new z.Parse(t)),
                        t.rootFileInfo)
            ...
            v = function (e) {
                return function () {
                    ...
                    return (
                        e.apply(t, Array.prototype.slice.call(arguments, 0)), t
                    );
                };
            },
            d = Object.create(p);
    ...
    var It = {},
        Ct = function () {};
    Ct.prototype = Object.assign(new Ae(), {
        ...
        doXHR: function (e, t, i, n) {
            ...
            "function" == typeof r.overrideMimeType &&
                ...
                r.send(null),
                bt.isFileProtocol && !bt.fileAsync
    ...
    _t.prototype = Object.assign(new Me(), {
            ...
            return {
                ...
                remove: function (i) {
                    r.errorReporting && "html" !== r.errorReporting
                        ...
                        : (function (i) {
                              var n = t.document.getElementById(
                                  "less-error-message:" + e(i)
                              );
    ...
    if (window.less)
        for (var Et in window.less)
            window.less.hasOwnProperty(Et) && (Mt[Et] = window.less[Et]);
    !(function (e, i) {
        t(i, n(e)),
            ...
            (i.env =
                ...
                i.isFileProtocol
                    ? "development"
                    : "production"));
        var r = /!dumpLineNumbers:(comments|mediaquery|all)/.exec(
            e.location.hash
        );
    ...
    var Pt,
        ...
        Vt = (function (e, n) {
            ...
            !(function () {
                ...
                n.functions &&
                    s.functions.functionRegistry.addMultiple(n.functions);
            var h = /^text\/(x-)?less$/;
            function f(e) {
                var t = {};
                for (var i in e) e.hasOwnProperty(i) && (t[i] = e[i]);
            ...
            return (
                ...
                (s.unwatch = function () {
                    return (
                        clearInterval(s.watchTimer), (this.watchMode = !1), !1
                    );
                }),
    ...
    function Ft(e) {
        e.filename && console.warn(e), Mt.async || Rt.removeChild(Ot);
    }
    return (
        (window.less = Vt),
        Mt.onReady &&
            (/!watch/.test(window.location.hash) && Vt.watch(),
            Mt.async ||
                ((Pt = "body { display: none !important }"),
                (Rt =
                    document.head || document.getElementsByTagName("head")[0]),
                ((Ot = document.createElement("style")).type = "text/css"),
                Ot.styleSheet
                    ? (Ot.styleSheet.cssText = Pt)
                    : Ot.appendChild(document.createTextNode(Pt)),
                Rt.appendChild(Ot)),
            Vt.registerStylesheetsImmediately(),
            (Vt.pageLoadFinished = Vt.refresh("development" === Vt.env).then(
                Ft,
                Ft
            ))),
        Vt
